...
class LuciLogViewRefactorTests(unittest.TestCase):
    ...
    def test_school_preset_apply_button_is_explicit(self):
        ...
        self.assertIn("operatorSuffixFromSelectedId", self.js_text)
        self.assertIn("updateOperatorSuffixFromPreset", self.js_text)
        ...
        self.assertIn("return String(operatorId || '')", self.js_text)
